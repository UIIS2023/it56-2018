...
public class DialogModifyHexagon extends JDialog{
	...
	public DialogModifyHexagon(HexagonAdapter hexagon) {
		...
		btnLineColor.setBackground(hexagon.getLineColor());
		...
		btnFillColor.setBackground(hexagon.getFillColor());
					...
					public void actionPerformed(ActionEvent e) {
						try {
							...
							if(dialogCenterX <= 0 || dialogCenterY <= 0 || dialogRadius <= 0) {
								...
								//hexagon.moveOn(dialogCenterX, dialogCenterY);
								//hexagon.setR(dialogRadius);;
								//hexagon.setLineColor(btnLineColor.getBackground());
